...
const render = async ({
    wid = '',
    pp = toBase64(fs.readFileSync(path.join(src, 'image', 'avatar_contact.png')), 'image/png'),
    name = '',
    title = '',
    text = '',
    background = toBase64(fs.readFileSync(path.join(src, 'image', 'Aesthetic_000.jpeg')), 'image/jpeg'),
} = {}, format = 'png') => {
